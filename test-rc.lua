...
beautiful.init("/home/gv/.config/awesome/themes/mine/theme.lua")
...
root.buttons(awful.util.table.join(
    awful.button({ }, 3, function () create_mainmenu():toggle() end),
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "w", function () create_mainmenu:show() end),
