...
local cascade = {}
cascade.cascade_offset_x = 32
cascade.cascade_offset_y = 8
...
function cascade.arrange(p)
    ...
    local current_cascade_offset_x = cascade.cascade_offset_x * (how_many - 1)
    local current_cascade_offset_y = cascade.cascade_offset_y * (how_many - 1)
    ...
    do
        ...
        g.x = wa.x + (how_many - i) * cascade.cascade_offset_x
        g.y = wa.y + (i - 1) * cascade.cascade_offset_y
